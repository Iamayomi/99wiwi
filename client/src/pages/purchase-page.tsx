          ...
          {step === PurchaseStep.SELECT_PACKAGE && (
            <>
              <Alert className="mb-6 bg-blue-500/10 text-blue-500 border-blue-500/30">
                ...
                <AlertDescription>Our larger packages offer better value with discounts up to 25%!</AlertDescription>
              </Alert>
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-end gap-2">
                ...
                <Button onClick={handleContinue} disabled={!selectedPackageId} className="sm:ml-2">
          ...
          {step === PurchaseStep.CHECKOUT && selectedPackageId && (
            <div className="max-w-2xl mx-auto">
              <div className="flex justify-between mb-6">
                <Button variant="ghost" size="sm" onClick={() => setStep(PurchaseStep.SELECT_PACKAGE)} className="text-muted-foreground hover:text-foreground p-0">
                  <ChevronLeft className="h-4 w-4 mr-1" />
                  Back to packages
                </Button>
              </div>

              <Checkout packageId={selectedPackageId} onSuccess={handleSuccess} onCancel={handleCancel} />
            </div>
          )}
