        ...
        <div className="bg-gradient-to-r from-[#2A2A2A] to-[#1E1E1E] border border-[#333333] p-6 rounded-xl mb-8 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center gap-3 mb-2">
              <h2 className="text-2xl md:text-3xl font-heading font-bold">Welcome to 99wiwi</h2>
            ...
            <p className="text-gray-400 max-w-xl mb-4">
              Experience the thrill of 99wiwi casino games with our virtual currency. Play responsibly!
              {user?.subscriptionTier && (
            ...
            <div className="flex flex-wrap gap-3">
              <Button className="bg-[#5465FF] hover:bg-[#6677FF] text-white font-medium py-2 px-6 rounded-lg transition duration-200">Get Started</Button>
