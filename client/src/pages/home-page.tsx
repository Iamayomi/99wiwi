      ...
      <div className="w-full max-w-[1400px] px-4 md:px-6 py-4 mx-auto overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-[#2A2A2A] to-[#1E1E1E] border border-[#333333] p-6 rounded-xl mb-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-gray-400 max-w-xl mb-4">
              Experience the thrill of 99wiwi casino games with our virtual
              currency. Play responsibly!
              {user?.subscriptionTier && (
                <span className="block mt-1 text-yellow-500/80">
                  {user.subscriptionTier === "bronze" &&
                    "Your Bronze VIP status grants you 300 daily coins and exclusive benefits!"}
                  {user.subscriptionTier === "silver" &&
                    "Your Silver VIP status grants you 600 daily coins and a 1.1x win multiplier!"}
                  {user.subscriptionTier === "gold" &&
                    "Your Gold VIP status grants you 1000 daily coins and a 1.25x win multiplier!"}
                </span>
              )}
            </p>
          ...
          <div className="mb-10">
            <div className="bg-gradient-to-r from-amber-900 to-yellow-800 border border-amber-700 p-6 rounded-xl relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-amber-100 max-w-xl mb-4">
                  Enjoy exclusive benefits including daily coin bonuses, reward
                  multipliers, and VIP status badges!
                </p>
        ...
        <div className="mb-10">
          <h2 className="text-xl font-heading font-bold flex items-center mb-4">
            <i className="ri-slot-machine-line mr-2 text-[#5465FF]"></i> Slots
            Machine
          </h2>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="lg:w-1/2 mb-6 lg:mb-0">
                ...
                <p className="text-gray-400 mb-4">
                  Spin the reels and match symbols to win. Get three identical
                  symbols in a row to win big prizes!
                </p>

                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="text-xs bg-[#1E1E1E] px-2 py-1 rounded-full text-gray-400">
                    96.5% RTP
                  </span>
                  <span className="text-xs bg-[#1E1E1E] px-2 py-1 rounded-full text-gray-400">
                    10+ Paylines
          ...
          <div className="bg-[#2A2A2A] rounded-xl border border-[#333333] p-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="lg:w-1/2 mb-6 lg:mb-0">
                ...
                <p className="text-gray-400 mb-4">
                  Set your target, place your bet, and roll the dice. Win if the
                  roll matches your prediction!
                </p>
          ...
          <div className="bg-[#2A2A2A] rounded-xl border border-[#333333] p-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="lg:w-1/2 mb-6 lg:mb-0">
                ...
                <p className="text-gray-400 mb-4">
                  Place your bet and watch the multiplier increase. Cash out
                  before the rocket crashes to secure your winnings!
                </p>
