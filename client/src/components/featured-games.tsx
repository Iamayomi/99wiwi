...
// import FeaturedCard from "./HeroPage/gamesUI/_component/featuredCard";
...
//   const buildPath = (game: any) => (game.slug ? `/${game.slug}?id=${game._id}` : game.path || `/${game.name?.toLowerCase().replace(/\s+/g, "_")}`);

//   return (
//     <>
//       {/* Featured or Fetched Games */}
//       <div className=" text-white px-4 md:px-26">
//         {/* <div className="uppercase mb-2">{selectedCategory}</div> */}
//         <div className="grid grid-cols-2 md:grid-cols-5 gap-2 mb-6">
//           {featuredGamesToShow.map((game: any) => (
//             <FeaturedCard
