    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 w-full overflow-x-hidden">
      {packages &&
        packages.map((pkg: CoinPackage) => {
          ...
          const valueProposition = pkg.id === "small" ? "Basic" : pkg.id === "medium" ? "Best for beginners" : pkg.id === "large" ? "Most popular" : "Best value";
          ...
          return (
            <Card
              ...
              <div className={cn("absolute inset-0 bg-gradient-to-b opacity-0 transition-opacity duration-300", isSelected ? "from-primary/10 to-transparent opacity-100" : "")} />
              ...
              <CardContent className="p-6 pt-12">
                ...
                <div className="flex items-center justify-center mb-6">
                  <div>
                    ...
                    {pkg.discount && pkg.discount > 0 ? (
                      ...
                      <span className="ml-2 text-muted-foreground text-sm opacity-0">spacer</span>
                    )}
                  </div>
                </div>
                ...
                <Button
                  ...
                  className={cn("w-full transition-all", isSelected ? "bg-primary hover:bg-primary/90" : "")}
